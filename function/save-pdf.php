...
if(isset($_FILES["pdfFile"])) {
    ...
    $clientFileName = "pembelian-stok.pdf"; // File name provided from client-side
    ...
    if (move_uploaded_file($_FILES["pdfFile"]["tmp_name"], $targetFile)) {
        ...
        $query = "INSERT INTO laporan (file, tipe, tgl_laporan) VALUES ('$newFileName', 'pembelian', '$todayDateTime')";
